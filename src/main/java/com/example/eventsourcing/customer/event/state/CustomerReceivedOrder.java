...
@Getter
@Setter
public class CustomerReceivedOrder extends UpdateStatefulAggregateEvent<Customer, CustomerState> {

    @Override
    public CustomerState getState() {
        return CustomerState.ORDER_RECEIVED;
    }

    @Override
    public boolean canTransitionFrom(CustomerState state) {
        return CustomerState.ORDER_CONFIRMED.equals(state);
    }
}